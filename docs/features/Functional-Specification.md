...
### 5.2 ダンジョンの運営
- **入場料の設定**:
    - 管理者はダンジョンへの入場料をゴールドで設定できます。
    - プレイヤーがダンジョンに進入した際、設定された金額がプレイヤーの所持金から減算され、管理者の所持金に加算されます。
    - 入場料が不足しているプレイヤーは、そのダンジョンに進入することはできません。
- **クリア報酬**:
    - 管理者はプレイヤーを誘い込むために、自身の所持品（ゴールドまたはアイテム）からクリア報酬を設定することができます。
    - プレイヤーがダンジョンの最深部の階段を下りる、または特定のクリア条件を満たした際に、設定された報酬がプレイヤーへ付与されます。
