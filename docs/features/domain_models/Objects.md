...
| `strong_wall` | 頑丈な壁 | `MATERIAL` | None | 500 | 3 | 5000 | `#` | 建築用資材。通常攻撃無効、特定のスキル（ID 106等）で破壊可能。 |
| `door` | 扉 | `MATERIAL` | None | 200 | 1 | 3000 | `+` | 建築用資材、開閉可能 |
| `breakable_wall` | 壊れる壁 | `MATERIAL` | None | 80 | 1 | 5000 | `#` | 建築用資材。HP 10。通常攻撃（固定 1 ダメージ）で破壊可能。 |
