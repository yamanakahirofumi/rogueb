...
- **新規習得時の挙動**: レベルアップや進化、卵からの「孵化」、あるいは[モンスター融合システム](../Monster-Fusion-System.md)による「融合（系統継承合体・特殊進化合体）」によって 5 つ目のスキルを習得（継承）しようとした場合、プレイヤーは「現在のスキルを忘れて新しいスキルを習得する」か「新しいスキルの習得を諦める」か（または残す4つのスキルを手動で選択する）を選択する必要があります。
...
| `metal_slime` | [メタルスライム](#species-metal_slime) | `SLIME` | 2 | None | 150 | 80 | 15 | 10 | 12 | 60 | 5 | 40 | 25 | 20 | `x` | `SLIME_BODY`, `STATUS_IMMUNITY` | 306 | NORMAL | 25 | 1000 | 2500 | - |
| `high_demon` | [ハイデーモン](#species-high_demon) | `DEMON` | 4 | Dark | 600 | 300 | 160 | 80 | 45 | 30 | 40 | 35 | 15 | 20 | `Y` | - | 201, 204 | AGGRESSIVE | 40 | 1500 | 5000 | - |
| `gale_wolf` | [ゲイルウルフ](#species-gale_wolf) | `BEAST` | 3 | Wind | 300 | 150 | 75 | 40 | 28 | 20 | 20 | 15 | 25 | 15 | `F` | `TRACKING` | 105 | AGGRESSIVE | 30 | 1000 | 3000 | - |
...
| <a id="species-metal_slime"></a>`metal_slime` | `306`: マヒの粉 (1), `103`: シールドバッシュ (10), `602`: 分裂 (25) |
| <a id="species-high_demon"></a>`high_demon` | `201`: ファイアボール (1), `204`: ダークブレス (1), `102`: 回転斬り (15), `501`: テレポート (20), `403`: トルネード (40) |
