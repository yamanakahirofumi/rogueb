...
- **暗闇 (Darkness)**: プレイヤーの視界が通常より狭くなります。
- **瘴気 (Miasma)**: 自然回復が無効化され、数歩ごとに微量のダメージを受けます。
- **魔力擾乱 (Magic Interference)**: 魔法や杖の消費 MP が 2 倍になります。
- **重力 (Heavy Gravity)**: 移動時のスタミナ消費が 2 倍になります。
