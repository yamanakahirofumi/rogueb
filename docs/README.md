...
- [モンスター特性強化システム](features/Monster-Trait-Enhancement-System.md)：特性をより上位の効果へ強化する条件、アイテム、および確率に関する仕様
...
- [分散データ整合性](implementation/Distributed-Consistency.md)：マイクロサービス間でのデータ整合性確保の手法
