...
### [x] モンスター融合関連種族のドメイン定義追加
- **概要**: 特殊融合合体の仕様で定義されていたが、基本モンスター種族一覧に存在しなかった 4 種族について、詳細パラメータと習得スキルスケジュールを追加。
- **解決策**: [モンスター ドメインモデル](./features/domain_models/Monster.md) の Section 5.1 および Section 5.2 に、`metal_spirit`, `metal_slime`, `high_demon`, `gale_wolf` の情報を追加し、ドキュメント間の一貫性を確保。
